...
public class BetService {
    ...
    public boolean addBet(Long idMatch, Long idBettor, String winnerTeam, float odds, float amount) {
        ...
        if (match.getStatus().equals(StatusMatchEnum.NOT_STARTED) && user.getAmount() >= amount) {
            Bet bet = new Bet(winnerTeam, odds, amount, ResultBetEnum.NOT_FINISHED, LocalDateTime.now(), match, user);
